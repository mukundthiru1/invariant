...
const INVARIANT_MITRE_MAP: Record<string, MitreMapping> = {
    ...
    xpath_injection: { invariantClass: 'xpath_injection', techniques: [T1190], rationale: 'XPath predicate manipulation bypasses authentication and authorization logic in XML-backed applications' },
    ognl_injection: { invariantClass: 'ognl_injection', techniques: [T1190, T1059], rationale: 'OGNL expression injection in Java frameworks can invoke Runtime and execute arbitrary commands' },
