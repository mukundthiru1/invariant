...
start_idx = text.find('fn owasp_top10_2021_for_class(class: InvariantClass) -> &\'static str {')
end_idx = text.find('pub fn compliance_mapping_for_class(class: InvariantClass) -> ComplianceMapping {')

# Also delete ALL_CLASSES array since we use crate::class_registry::ALL_CLASSES
text = text.replace('const ALL_CLASSES', '// const ALL_CLASSES')
...
"""
    text = before + controls_code + after
